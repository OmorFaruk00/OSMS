			...
			<div class="col-sm-2 bg-light sidebar py-3 ">
				<div class="sidebar-sticky navbar">
					<ul class="nav flex-column ">
						...
						<li class="nav-item "> <a class="nav-link <?php if(PAGE == 'SubmitRequester'){echo 'active';} ?>" href="submit_requester.php"><i class=" fas fa-registered">Submit Rquests</i></a></li>
						<li class="nav-item "> <a class="nav-link <?php if(PAGE == 'RquestsOverview'){echo 'active';} ?>" href="requester_overview.php"><i class=" fas fa-eye">Rquests Overview</i></a></li>
						<li class="nav-item "> <a class="nav-link <?php if(PAGE == 'ProductDetails'){echo 'active';} ?>" href="product_details.php"><i class=" fas fa-ballot-check"> Available Product</i></a></li>
						<li class="nav-item "> <a class="nav-link <?php if(PAGE == 'ServiceStatus'){echo 'active';} ?>" href="service_status.php"><i class="fas fa-check-square"></i>Service Status</i></a></li>
